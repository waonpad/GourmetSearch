...
import type { GameClip as GameClipType, LikedGameClip } from '../types';

type LikedGameClipListItemProps = {
  likedData: LikedGameClip;
};

export const LikedGameClipListItem = ({ likedData }: LikedGameClipListItemProps) => {
  const auth = useAuthContext();

  const originData = useFirestore<GameClipType>(likedData.originRef);
