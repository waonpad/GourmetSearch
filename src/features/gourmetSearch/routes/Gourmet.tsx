...
import { GourmetSReviewList } from '../components/GourmetReviewList';
import {
  ShopGenre,
  ShopAccess,
  ShopAddress,
...
export const Gourmet = () => {
  ...
  // error
  if (!gourmetQuery.data || !isHotpepperGourmetSuccessResponse(gourmetQuery.data)) {
